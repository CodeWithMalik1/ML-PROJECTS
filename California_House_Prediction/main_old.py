...
for train_index, test_index in split.split(housing, housing["income_cat"]):
    strat_train_set = housing.loc[train_index].drop("income_cat", axis=1)#we will work on this values
    strat_test_set = housing.loc[test_index].drop("income_cat", axis=1)#keep aside this data
